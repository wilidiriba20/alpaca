let hair = ["bang", "curly", "default", "elegant", "fancy", "quiff", "short"];
...
let buttons = Array.from(document.getElementsByTagName("button")); // FIX
...
function buttonscreate(type) {
  ...
  else if (type === "background") arr = background;
